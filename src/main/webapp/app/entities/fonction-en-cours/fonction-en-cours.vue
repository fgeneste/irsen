      ...
      <table class="table table-striped" aria-describedby="fonctionEnCours">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="$t('irsenApp.fonctionEnCours.mandatEnCours')">Mandat En Cours</span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
          <tr v-for="fonctionEnCours in fonctionEnCours" :key="fonctionEnCours.id" data-cy="entityTable">
            ...
            <td>
              <div v-if="fonctionEnCours.mandatEnCours">
                <router-link :to="{ name: 'MandatEnCoursView', params: { mandatEnCoursId: fonctionEnCours.mandatEnCours.id } }">{{
                  fonctionEnCours.mandatEnCours.id
                }}</router-link>
              </div>
            </td>
            <td class="text-right">
