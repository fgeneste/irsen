    ...
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('irsenApp.mandatEnCours.mandat')" for="mandat-en-cours-mandat">Mandat</label>
            <select class="form-control" id="mandat-en-cours-mandat" data-cy="mandat" name="mandat" v-model="mandatEnCours.mandat">
              <option v-bind:value="null"></option>
              <option
                v-bind:value="mandatEnCours.mandat && mandatOption.id === mandatEnCours.mandat.id ? mandatEnCours.mandat : mandatOption"
                v-for="mandatOption in mandats"
                :key="mandatOption.id"
              >
                {{ mandatOption.id }}
              </option>
