      ...
      <table class="table table-striped" aria-describedby="mandatAnciens">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="$t('irsenApp.mandatAncien.mandat')">Mandat</span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
          <tr v-for="mandatAncien in mandatAnciens" :key="mandatAncien.id" data-cy="entityTable">
            ...
            <td>
              <div v-if="mandatAncien.mandat">
                <router-link :to="{ name: 'MandatView', params: { mandatId: mandatAncien.mandat.id } }">{{
                  mandatAncien.mandat.id
                }}</router-link>
              </div>
            </td>
            <td class="text-right">
