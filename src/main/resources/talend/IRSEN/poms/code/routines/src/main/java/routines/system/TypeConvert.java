...
public class TypeConvert {
    ...
    public static boolean String2boolean(String o) {
        if (o == null) return false;
        if (
            o.equalsIgnoreCase("true") || o.equalsIgnoreCase("false")
        ) return Boolean.valueOf(o); //$NON-NLS-1$ //$NON-NLS-2$
        throw ConvertTypeIllegalArgumentException.forInputArgument(o, "boolean");
    }
    ...
    public static char String2char(String o) {
        if (o == null) return (char) 0;
        if (o.length() > 1) throw ConvertTypeIllegalArgumentException.forInputArgument(o, "char");
        return o.charAt(0);
    }
    ...
    public static Character String2Character(String o) {
        if (o == null) return null;
        if (o.length() > 1) throw ConvertTypeIllegalArgumentException.forInputArgument(o, "Character");
    ...
    public static Date String2Date(String o, String pattern) {
        if (o == null || "".equals(o.trim())) return null;
