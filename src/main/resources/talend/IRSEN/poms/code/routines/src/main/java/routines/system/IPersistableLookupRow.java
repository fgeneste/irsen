...
public interface IPersistableLookupRow<R> {
    ...
    public default void writeKeysData(Marshaller marshaller) {
        //sub-class need to override this method
        throw new UnsupportedOperationException("Method need to be override");
    }

    public default void readKeysData(Unmarshaller in) {
        throw new UnsupportedOperationException("Method need to be override");
    }

    public default void writeValuesData(DataOutputStream dataOut, Marshaller objectOut) {
        throw new UnsupportedOperationException("Method need to be override");
    }

    public default void readValuesData(DataInputStream dataIn, Unmarshaller objectIn) {
        throw new UnsupportedOperationException("Method need to be override");
    }

    public default boolean supportMarshaller() {
