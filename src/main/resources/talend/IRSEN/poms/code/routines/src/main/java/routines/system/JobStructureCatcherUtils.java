...
public class JobStructureCatcherUtils {
    ...
    java.util.List<JobStructureCatcherMessage> messages = java.util.Collections.synchronizedList(
    ...
    public void addConnectionSchemaMessage(
        String source_component_id,
        String source_component_name,
        String target_component_id,
        String target_component_name,
        String current_connector,
    ...
    public void addConnectionMessage(
        String component_id,
        String component_label,
        String component_name,
        boolean current_connector_as_input,
        String current_connector_type,
        String current_connector,
        long total_row_number,
        long start_time,
        long end_time
    ) {
        JobStructureCatcherMessage scm = new JobStructureCatcherMessage();
