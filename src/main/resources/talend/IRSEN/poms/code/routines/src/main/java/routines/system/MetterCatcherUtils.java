...
public class MetterCatcherUtils {
    ...
    java.util.List<MetterCatcherMessage> messages = java.util.Collections.synchronizedList(new java.util.ArrayList<MetterCatcherMessage>());
