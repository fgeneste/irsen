...
public class TalendDate {
     ...
     * {example} formatDate("yyyy-MM-dd", new Date()) #
     */
    public static synchronized String formatDateInUTC(String pattern, java.util.Date date) {
     ...
     */
    public static synchronized String formatDateInTimeZone(String pattern, java.util.Date date, String zoneId) {
        DateFormat format = FastDateParser.getInstance(pattern);
     ...
     */
    public static synchronized String formatDateLocale(String pattern, java.util.Date date, String languageOrCountyCode) {
    ...
    public static synchronized Date parseDate(String pattern, String stringDate, boolean isLenient) {
        try {
            ...
            if (hasZone) {
                ...
                TalendTimestampWithTZ tstz = new TalendTimestampWithTZ(
    ...
    public static Date getRandomDate(String minDate, String maxDate) {
        ...
        long random = minCal.getTimeInMillis() + (long) ((maxCal.getTimeInMillis() - minCal.getTimeInMillis() + 1) * RandomUtils.random());
    ...
    public static void test_getRandomDate() {
        System.out.println("getRandomDate: " + TalendDate.formatDate("yyyy-MM-dd HH:mm:ss", TalendDate.getRandomDate(null, null))); //$NON-NLS-1$
    }
    ...
    public static void test_compareDate() {
        System.out.println(
            "compareDate: " + Boolean.toString(TalendDate.compareDate(new Date(), new Date(System.currentTimeMillis() - 10000)) == 1)
        ); //$NON-NLS-1$
    }
