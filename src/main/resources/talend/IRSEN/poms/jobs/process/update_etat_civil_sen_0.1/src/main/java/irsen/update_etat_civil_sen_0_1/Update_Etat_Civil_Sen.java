...
package irsen.update_etat_civil_sen_0_1;
...
/**
 * Job: Update_Etat_Civil_Sen Purpose: <br>
 * Description: <br>
 *
 ...
 * @status
 */
public class Update_Etat_Civil_Sen implements TalendJob {
    ...
    private final String jobName = "Update_Etat_Civil_Sen";
        ...
        public void printStackTrace() {
            ...
            if (!(e instanceof TDieException)) {
                if (e instanceof TalendException) {
                    ...
                    Update_Etat_Civil_Sen.this.exception = e;
                }
            }
            if (!(e instanceof TalendException)) {
                try {
                    for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
                        if (m.getName().compareTo(currentComponent + "_error") == 0) {
                            m.invoke(Update_Etat_Civil_Sen.this, new Object[] { e, currentComponent, globalMap });
                            break;
                        }
                    }
    ...
    public static class SEN_SCDStruct implements routines.system.IPersistableRow<SEN_SCDStruct> {

        static final byte[] commonByteArrayLock_IRSEN_Update_Etat_Civil_Sen = new byte[0];
        static byte[] commonByteArray_IRSEN_Update_Etat_Civil_Sen = new byte[0];
        ...
        private String readString(ObjectInputStream dis) throws IOException {
            ...
            if (length == -1) {
                ...
                if (length > commonByteArray_IRSEN_Update_Etat_Civil_Sen.length) {
                    if (length < 1024 && commonByteArray_IRSEN_Update_Etat_Civil_Sen.length == 0) {
                        commonByteArray_IRSEN_Update_Etat_Civil_Sen = new byte[1024];
                    } else {
                        commonByteArray_IRSEN_Update_Etat_Civil_Sen = new byte[2 * length];
                    }
                }
                dis.readFully(commonByteArray_IRSEN_Update_Etat_Civil_Sen, 0, length);
                strReturn = new String(commonByteArray_IRSEN_Update_Etat_Civil_Sen, 0, length, utf8Charset);
            }
            return strReturn;
        }
        ...
        private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
            ...
            if (length == -1) {
                ...
                unmarshaller.readFully(commonByteArray_IRSEN_Update_Etat_Civil_Sen, 0, length);
                strReturn = new String(commonByteArray_IRSEN_Update_Etat_Civil_Sen, 0, length, utf8Charset);
            }
            return strReturn;
        }
        ...
        public void readData(ObjectInputStream dis) {
            synchronized (commonByteArrayLock_IRSEN_Update_Etat_Civil_Sen) {
                try {
                    int length = 0;
         ...
         * Compare keys
         */
        public int compareTo(SEN_SCDStruct other) {
            int returnValue = -1;
    ...
    public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
        ...
        try {
            ...
            if (resumeIt || globalResumeTicket) { // start the resume
                ...
                SEN_SCDStruct SEN_SCD = new SEN_SCDStruct();
                ...
                if (execStat) {
                    runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "SEN_SCD");
                }
                ...
                final String decryptedPassword_tDBSCD_1 = routines.system.PasswordEncryptUtil.decryptPassword(
                    "enc:routine.encryption.key.v1:lM2Ang/RoFixZIGoAd7/u7U2t/qnqRV0HxDkbaWdDk1/Bwngh5cCuQ=="
                );
                ...
                String search_tDBSCD_1 =
                    "SELECT \"SENMAT\", \"CATPROCOD\", \"PCSCOD\", \"QUACOD\", \"SENDATNAI\", \"SENDESPRO\", \"SENDPTNUMNAI\", \"SENEMA\", \"SENLIENAI\", \"SENNOMMAR\", \"SENNOMPAT\", \"SENNOMTEC\", \"SENNOMUSE\", \"SENNOMUSECAP\", \"SENNUMTELSEN\", \"SENPRENOMCIV\", \"SENPRENOMUSE\" FROM \"" +
                    tableName_tDBSCD_1 +
                    "\"";
                ...
                while (resultSet_tDBSCD_1.next()) {
                    ...
                    if (resultSet_tDBSCD_1.getObject(2) != null) {
                        row_tDBSCD_1.CATPROCOD = resultSet_tDBSCD_1.getString(2);
                    }
                    if (resultSet_tDBSCD_1.getObject(3) != null) {
                        row_tDBSCD_1.PCSCOD = resultSet_tDBSCD_1.getString(3);
                    }
                    if (resultSet_tDBSCD_1.getObject(4) != null) {
                        row_tDBSCD_1.QUACOD = resultSet_tDBSCD_1.getString(4);
                    }
                    if (resultSet_tDBSCD_1.getObject(5) != null) {
                        row_tDBSCD_1.SENDATNAI = resultSet_tDBSCD_1.getString(5);
                    }
                    if (resultSet_tDBSCD_1.getObject(6) != null) {
                        row_tDBSCD_1.SENDESPRO = resultSet_tDBSCD_1.getString(6);
                    }
                    if (resultSet_tDBSCD_1.getObject(7) != null) {
                        row_tDBSCD_1.SENDPTNUMNAI = resultSet_tDBSCD_1.getLong(7);
                    }
                    if (resultSet_tDBSCD_1.getObject(8) != null) {
                        row_tDBSCD_1.SENEMA = resultSet_tDBSCD_1.getString(8);
                    }
                    if (resultSet_tDBSCD_1.getObject(9) != null) {
                        row_tDBSCD_1.SENLIENAI = resultSet_tDBSCD_1.getString(9);
                    }
                    if (resultSet_tDBSCD_1.getObject(10) != null) {
                        row_tDBSCD_1.SENNOMMAR = resultSet_tDBSCD_1.getString(10);
                    }
                    if (resultSet_tDBSCD_1.getObject(11) != null) {
                        row_tDBSCD_1.SENNOMPAT = resultSet_tDBSCD_1.getString(11);
                    }
                    if (resultSet_tDBSCD_1.getObject(12) != null) {
                        row_tDBSCD_1.SENNOMTEC = resultSet_tDBSCD_1.getString(12);
                    }
                    if (resultSet_tDBSCD_1.getObject(13) != null) {
                        row_tDBSCD_1.SENNOMUSE = resultSet_tDBSCD_1.getString(13);
                    }
                    if (resultSet_tDBSCD_1.getObject(14) != null) {
                        row_tDBSCD_1.SENNOMUSECAP = resultSet_tDBSCD_1.getString(14);
                    }
                    if (resultSet_tDBSCD_1.getObject(15) != null) {
                        row_tDBSCD_1.SENNUMTELSEN = resultSet_tDBSCD_1.getString(15);
                    }
                    if (resultSet_tDBSCD_1.getObject(16) != null) {
                        row_tDBSCD_1.SENPRENOMCIV = resultSet_tDBSCD_1.getString(16);
                    }
                    if (resultSet_tDBSCD_1.getObject(17) != null) {
                        row_tDBSCD_1.SENPRENOMUSE = resultSet_tDBSCD_1.getString(17);
                    }
                ...
                String insertionSQL_tDBSCD_1 =
                    "INSERT INTO \"" +
                    tableName_tDBSCD_1 +
                    "\"(\"SENMAT\", \"CATPROCOD\", \"PCSCOD\", \"QUACOD\", \"SENDATNAI\", \"SENDESPRO\", \"SENDPTNUMNAI\", \"SENEMA\", \"SENLIENAI\", \"SENNOMMAR\", \"SENNOMPAT\", \"SENNOMTEC\", \"SENNOMUSE\", \"SENNOMUSECAP\", \"SENNUMTELSEN\", \"SENPRENOMCIV\", \"SENPRENOMUSE\") VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                java.sql.PreparedStatement insertionStatement_tDBSCD_1 = connection_tDBSCD_1.prepareStatement(insertionSQL_tDBSCD_1);
                String updateSQLForType1_tDBSCD_1 =
                    "UPDATE \"" +
                    tableName_tDBSCD_1 +
                    "\" SET \"CATPROCOD\" = ?, \"PCSCOD\" = ?, \"QUACOD\" = ?, \"SENDATNAI\" = ?, \"SENDESPRO\" = ?, \"SENDPTNUMNAI\" = ?, \"SENEMA\" = ?, \"SENLIENAI\" = ?, \"SENNOMMAR\" = ?, \"SENNOMPAT\" = ?, \"SENNOMTEC\" = ?, \"SENNOMUSE\" = ?, \"SENNOMUSECAP\" = ?, \"SENNUMTELSEN\" = ?, \"SENPRENOMCIV\" = ?, \"SENPRENOMUSE\" = ? WHERE \"SENMAT\" = ?";
                ...
                SEN_SCDStruct SEN_SCD_tmp = new SEN_SCDStruct();
                // ###############################
                ...
                final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
                    "enc:routine.encryption.key.v1:Oh4TVFuG2a0w5sTZDqm98gFlPRI1P9drQJru4A=="
                );
                ...
                try {
                    ...
                    while (rs_tDBInput_1.next()) {
                        ...
                        if (tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
                            ...
                            // and it contains more one result from keys : row2.dptcod = '" +
                            // row2HashKey.dptcod + "'");
                        } // G 071
                        ...
                        { // start of Var scope
                            ...
                            if (!rejectedInnerJoin_tMap_1) {
                                // # Output table : 'SEN_SCD'
                                SEN_SCD_tmp.SENMAT = row1.SENMAT;
                                SEN_SCD_tmp.QUACOD = row1.QUACOD;
                                SEN_SCD_tmp.SENNOMUSE = row1.SENNOMUSE;
                                SEN_SCD_tmp.SENNOMPAT = row1.SENNOMPAT;
                                SEN_SCD_tmp.SENNOMMAR = row1.SENNOMMAR;
                                SEN_SCD_tmp.SENNOMTEC = row1.SENNOMTEC;
                                SEN_SCD_tmp.SENPRENOMUSE = row1.SENPRENOMUSE;
                                SEN_SCD_tmp.SENPRENOMCIV = row1.SENPRENOMCIV;
                                SEN_SCD_tmp.SENDATNAI = row1.SENDATNAI;
                                SEN_SCD_tmp.SENLIENAI = row1.SENLIENAI;
                                SEN_SCD_tmp.SENDESPRO = row1.SENDESPRO;
                                SEN_SCD_tmp.PCSCOD = row3.pcscod;
                                SEN_SCD_tmp.CATPROCOD = row1.CATPROCOD_TO_TRANSLATE;
                                SEN_SCD_tmp.SENEMA = row1.SENEMA;
                                SEN_SCD_tmp.SENNUMTELSEN = row1.SENNUMTELSEN;
                                SEN_SCD_tmp.SENNOMUSECAP = row1.SENNOMUSECAP;
                                SEN_SCD_tmp.SENDPTNUMNAI = row2.dptnum;
                                SEN_SCD = SEN_SCD_tmp;
                        ...
                        if (SEN_SCD != null) {
                            ...
                            if (execStat) {
                                runStat.updateStatOnConnection(iterateId, 1, 1, "SEN_SCD");
                            }

                            try {
                                lookUpKey_tDBSCD_1 = new SCDSK_tDBSCD_1();
                                lookUpKey_tDBSCD_1.SENMAT = SEN_SCD.SENMAT;
                                ...
                                if (lookUpValue_tDBSCD_1 == null) {
                                    ...
                                    if (SEN_SCD.SENMAT == null) {
                                        insertionStatement_tDBSCD_1.setNull(1, java.sql.Types.VARCHAR);
                                    } else {
                                        insertionStatement_tDBSCD_1.setString(1, SEN_SCD.SENMAT);
                                    }

                                    if (SEN_SCD.CATPROCOD == null) {
                                        insertionStatement_tDBSCD_1.setNull(2, java.sql.Types.VARCHAR);
                                    } else {
                                        insertionStatement_tDBSCD_1.setString(2, SEN_SCD.CATPROCOD);
                                    }

                                    if (SEN_SCD.PCSCOD == null) {
                                        insertionStatement_tDBSCD_1.setNull(3, java.sql.Types.VARCHAR);
                                    } else {
                                        insertionStatement_tDBSCD_1.setString(3, SEN_SCD.PCSCOD);
                                    }

                                    if (SEN_SCD.QUACOD == null) {
                                        insertionStatement_tDBSCD_1.setNull(4, java.sql.Types.VARCHAR);
                                    } else {
                                        insertionStatement_tDBSCD_1.setString(4, SEN_SCD.QUACOD);
                                    }

                                    if (SEN_SCD.SENDATNAI == null) {
                                        insertionStatement_tDBSCD_1.setNull(5, java.sql.Types.VARCHAR);
                                    } else {
                                        insertionStatement_tDBSCD_1.setString(5, SEN_SCD.SENDATNAI);
                                    }

                                    if (SEN_SCD.SENDESPRO == null) {
                                        insertionStatement_tDBSCD_1.setNull(6, java.sql.Types.VARCHAR);
                                    } else {
                                        insertionStatement_tDBSCD_1.setString(6, SEN_SCD.SENDESPRO);
                                    }

                                    if (SEN_SCD.SENDPTNUMNAI == null) {
                                        insertionStatement_tDBSCD_1.setNull(7, java.sql.Types.INTEGER);
                                    } else {
                                        insertionStatement_tDBSCD_1.setLong(7, SEN_SCD.SENDPTNUMNAI);
                                    }

                                    if (SEN_SCD.SENEMA == null) {
                                        insertionStatement_tDBSCD_1.setNull(8, java.sql.Types.VARCHAR);
                                    } else {
                                        insertionStatement_tDBSCD_1.setString(8, SEN_SCD.SENEMA);
                                    }

                                    if (SEN_SCD.SENLIENAI == null) {
                                        insertionStatement_tDBSCD_1.setNull(9, java.sql.Types.VARCHAR);
                                    } else {
                                        insertionStatement_tDBSCD_1.setString(9, SEN_SCD.SENLIENAI);
                                    }

                                    if (SEN_SCD.SENNOMMAR == null) {
                                        insertionStatement_tDBSCD_1.setNull(10, java.sql.Types.VARCHAR);
                                    } else {
                                        insertionStatement_tDBSCD_1.setString(10, SEN_SCD.SENNOMMAR);
                                    }

                                    if (SEN_SCD.SENNOMPAT == null) {
                                        insertionStatement_tDBSCD_1.setNull(11, java.sql.Types.VARCHAR);
                                    } else {
                                        insertionStatement_tDBSCD_1.setString(11, SEN_SCD.SENNOMPAT);
                                    }

                                    if (SEN_SCD.SENNOMTEC == null) {
                                        insertionStatement_tDBSCD_1.setNull(12, java.sql.Types.VARCHAR);
                                    } else {
                                        insertionStatement_tDBSCD_1.setString(12, SEN_SCD.SENNOMTEC);
                                    }

                                    if (SEN_SCD.SENNOMUSE == null) {
                                        insertionStatement_tDBSCD_1.setNull(13, java.sql.Types.VARCHAR);
                                    } else {
                                        insertionStatement_tDBSCD_1.setString(13, SEN_SCD.SENNOMUSE);
                                    }

                                    if (SEN_SCD.SENNOMUSECAP == null) {
                                        insertionStatement_tDBSCD_1.setNull(14, java.sql.Types.VARCHAR);
                                    } else {
                                        insertionStatement_tDBSCD_1.setString(14, SEN_SCD.SENNOMUSECAP);
                                    }

                                    if (SEN_SCD.SENNUMTELSEN == null) {
                                        insertionStatement_tDBSCD_1.setNull(15, java.sql.Types.VARCHAR);
                                    } else {
                                        insertionStatement_tDBSCD_1.setString(15, SEN_SCD.SENNUMTELSEN);
                                    }

                                    if (SEN_SCD.SENPRENOMCIV == null) {
                                        insertionStatement_tDBSCD_1.setNull(16, java.sql.Types.VARCHAR);
                                    } else {
                                        insertionStatement_tDBSCD_1.setString(16, SEN_SCD.SENPRENOMCIV);
                                    }

                                    if (SEN_SCD.SENPRENOMUSE == null) {
                                        insertionStatement_tDBSCD_1.setNull(17, java.sql.Types.VARCHAR);
                                    } else {
                                        insertionStatement_tDBSCD_1.setString(17, SEN_SCD.SENPRENOMUSE);
                                    }

                                    nb_line_inserted_tDBSCD_1 += insertionStatement_tDBSCD_1.executeUpdate();
                                } else {
                                    if (
                                        (lookUpValue_tDBSCD_1.CATPROCOD == null && SEN_SCD.CATPROCOD != null) ||
                                        (
                                            lookUpValue_tDBSCD_1.CATPROCOD != null &&
                                            !lookUpValue_tDBSCD_1.CATPROCOD.equals(SEN_SCD.CATPROCOD)
                                        ) ||
                                        (lookUpValue_tDBSCD_1.PCSCOD == null && SEN_SCD.PCSCOD != null) ||
                                        (lookUpValue_tDBSCD_1.PCSCOD != null && !lookUpValue_tDBSCD_1.PCSCOD.equals(SEN_SCD.PCSCOD)) ||
                                        (lookUpValue_tDBSCD_1.QUACOD == null && SEN_SCD.QUACOD != null) ||
                                        (lookUpValue_tDBSCD_1.QUACOD != null && !lookUpValue_tDBSCD_1.QUACOD.equals(SEN_SCD.QUACOD)) ||
                                        (lookUpValue_tDBSCD_1.SENDATNAI == null && SEN_SCD.SENDATNAI != null) ||
                                        (
                                            lookUpValue_tDBSCD_1.SENDATNAI != null &&
                                            !lookUpValue_tDBSCD_1.SENDATNAI.equals(SEN_SCD.SENDATNAI)
                                        ) ||
                                        (lookUpValue_tDBSCD_1.SENDESPRO == null && SEN_SCD.SENDESPRO != null) ||
                                        (
                                            lookUpValue_tDBSCD_1.SENDESPRO != null &&
                                            !lookUpValue_tDBSCD_1.SENDESPRO.equals(SEN_SCD.SENDESPRO)
                                        ) ||
                                        (lookUpValue_tDBSCD_1.SENDPTNUMNAI == null && SEN_SCD.SENDPTNUMNAI != null) ||
                                        (
                                            lookUpValue_tDBSCD_1.SENDPTNUMNAI != null &&
                                            !lookUpValue_tDBSCD_1.SENDPTNUMNAI.equals(SEN_SCD.SENDPTNUMNAI)
                                        ) ||
                                        (lookUpValue_tDBSCD_1.SENEMA == null && SEN_SCD.SENEMA != null) ||
                                        (lookUpValue_tDBSCD_1.SENEMA != null && !lookUpValue_tDBSCD_1.SENEMA.equals(SEN_SCD.SENEMA)) ||
                                        (lookUpValue_tDBSCD_1.SENLIENAI == null && SEN_SCD.SENLIENAI != null) ||
                                        (
                                            lookUpValue_tDBSCD_1.SENLIENAI != null &&
                                            !lookUpValue_tDBSCD_1.SENLIENAI.equals(SEN_SCD.SENLIENAI)
                                        ) ||
                                        (lookUpValue_tDBSCD_1.SENNOMMAR == null && SEN_SCD.SENNOMMAR != null) ||
                                        (
                                            lookUpValue_tDBSCD_1.SENNOMMAR != null &&
                                            !lookUpValue_tDBSCD_1.SENNOMMAR.equals(SEN_SCD.SENNOMMAR)
                                        ) ||
                                        (lookUpValue_tDBSCD_1.SENNOMPAT == null && SEN_SCD.SENNOMPAT != null) ||
                                        (
                                            lookUpValue_tDBSCD_1.SENNOMPAT != null &&
                                            !lookUpValue_tDBSCD_1.SENNOMPAT.equals(SEN_SCD.SENNOMPAT)
                                        ) ||
                                        (lookUpValue_tDBSCD_1.SENNOMTEC == null && SEN_SCD.SENNOMTEC != null) ||
                                        (
                                            lookUpValue_tDBSCD_1.SENNOMTEC != null &&
                                            !lookUpValue_tDBSCD_1.SENNOMTEC.equals(SEN_SCD.SENNOMTEC)
                                        ) ||
                                        (lookUpValue_tDBSCD_1.SENNOMUSE == null && SEN_SCD.SENNOMUSE != null) ||
                                        (
                                            lookUpValue_tDBSCD_1.SENNOMUSE != null &&
                                            !lookUpValue_tDBSCD_1.SENNOMUSE.equals(SEN_SCD.SENNOMUSE)
                                        ) ||
                                        (lookUpValue_tDBSCD_1.SENNOMUSECAP == null && SEN_SCD.SENNOMUSECAP != null) ||
                                        (
                                            lookUpValue_tDBSCD_1.SENNOMUSECAP != null &&
                                            !lookUpValue_tDBSCD_1.SENNOMUSECAP.equals(SEN_SCD.SENNOMUSECAP)
                                        ) ||
                                        (lookUpValue_tDBSCD_1.SENNUMTELSEN == null && SEN_SCD.SENNUMTELSEN != null) ||
                                        (
                                            lookUpValue_tDBSCD_1.SENNUMTELSEN != null &&
                                            !lookUpValue_tDBSCD_1.SENNUMTELSEN.equals(SEN_SCD.SENNUMTELSEN)
                                        ) ||
                                        (lookUpValue_tDBSCD_1.SENPRENOMCIV == null && SEN_SCD.SENPRENOMCIV != null) ||
                                        (
                                            lookUpValue_tDBSCD_1.SENPRENOMCIV != null &&
                                            !lookUpValue_tDBSCD_1.SENPRENOMCIV.equals(SEN_SCD.SENPRENOMCIV)
                                        ) ||
                                        (lookUpValue_tDBSCD_1.SENPRENOMUSE == null && SEN_SCD.SENPRENOMUSE != null) ||
                                        (
                                            lookUpValue_tDBSCD_1.SENPRENOMUSE != null &&
                                            !lookUpValue_tDBSCD_1.SENPRENOMUSE.equals(SEN_SCD.SENPRENOMUSE)
                                        )
                                    ) {
                                        if (SEN_SCD.CATPROCOD == null) {
                                            updateForType1_tDBSCD_1.setNull(1, java.sql.Types.VARCHAR);
                                        } else {
                                            updateForType1_tDBSCD_1.setString(1, SEN_SCD.CATPROCOD);
                                        }

                                        if (SEN_SCD.PCSCOD == null) {
                                            updateForType1_tDBSCD_1.setNull(2, java.sql.Types.VARCHAR);
                                        } else {
                                            updateForType1_tDBSCD_1.setString(2, SEN_SCD.PCSCOD);
                                        }

                                        if (SEN_SCD.QUACOD == null) {
                                            updateForType1_tDBSCD_1.setNull(3, java.sql.Types.VARCHAR);
                                        } else {
                                            updateForType1_tDBSCD_1.setString(3, SEN_SCD.QUACOD);
                                        }

                                        if (SEN_SCD.SENDATNAI == null) {
                                            updateForType1_tDBSCD_1.setNull(4, java.sql.Types.VARCHAR);
                                        } else {
                                            updateForType1_tDBSCD_1.setString(4, SEN_SCD.SENDATNAI);
                                        }

                                        if (SEN_SCD.SENDESPRO == null) {
                                            updateForType1_tDBSCD_1.setNull(5, java.sql.Types.VARCHAR);
                                        } else {
                                            updateForType1_tDBSCD_1.setString(5, SEN_SCD.SENDESPRO);
                                        }

                                        if (SEN_SCD.SENDPTNUMNAI == null) {
                                            updateForType1_tDBSCD_1.setNull(6, java.sql.Types.INTEGER);
                                        } else {
                                            updateForType1_tDBSCD_1.setLong(6, SEN_SCD.SENDPTNUMNAI);
                                        }

                                        if (SEN_SCD.SENEMA == null) {
                                            updateForType1_tDBSCD_1.setNull(7, java.sql.Types.VARCHAR);
                                        } else {
                                            updateForType1_tDBSCD_1.setString(7, SEN_SCD.SENEMA);
                                        }

                                        if (SEN_SCD.SENLIENAI == null) {
                                            updateForType1_tDBSCD_1.setNull(8, java.sql.Types.VARCHAR);
                                        } else {
                                            updateForType1_tDBSCD_1.setString(8, SEN_SCD.SENLIENAI);
                                        }

                                        if (SEN_SCD.SENNOMMAR == null) {
                                            updateForType1_tDBSCD_1.setNull(9, java.sql.Types.VARCHAR);
                                        } else {
                                            updateForType1_tDBSCD_1.setString(9, SEN_SCD.SENNOMMAR);
                                        }

                                        if (SEN_SCD.SENNOMPAT == null) {
                                            updateForType1_tDBSCD_1.setNull(10, java.sql.Types.VARCHAR);
                                        } else {
                                            updateForType1_tDBSCD_1.setString(10, SEN_SCD.SENNOMPAT);
                                        }

                                        if (SEN_SCD.SENNOMTEC == null) {
                                            updateForType1_tDBSCD_1.setNull(11, java.sql.Types.VARCHAR);
                                        } else {
                                            updateForType1_tDBSCD_1.setString(11, SEN_SCD.SENNOMTEC);
                                        }

                                        if (SEN_SCD.SENNOMUSE == null) {
                                            updateForType1_tDBSCD_1.setNull(12, java.sql.Types.VARCHAR);
                                        } else {
                                            updateForType1_tDBSCD_1.setString(12, SEN_SCD.SENNOMUSE);
                                        }

                                        if (SEN_SCD.SENNOMUSECAP == null) {
                                            updateForType1_tDBSCD_1.setNull(13, java.sql.Types.VARCHAR);
                                        } else {
                                            updateForType1_tDBSCD_1.setString(13, SEN_SCD.SENNOMUSECAP);
                                        }

                                        if (SEN_SCD.SENNUMTELSEN == null) {
                                            updateForType1_tDBSCD_1.setNull(14, java.sql.Types.VARCHAR);
                                        } else {
                                            updateForType1_tDBSCD_1.setString(14, SEN_SCD.SENNUMTELSEN);
                                        }

                                        if (SEN_SCD.SENPRENOMCIV == null) {
                                            updateForType1_tDBSCD_1.setNull(15, java.sql.Types.VARCHAR);
                                        } else {
                                            updateForType1_tDBSCD_1.setString(15, SEN_SCD.SENPRENOMCIV);
                                        }

                                        if (SEN_SCD.SENPRENOMUSE == null) {
                                            updateForType1_tDBSCD_1.setNull(16, java.sql.Types.VARCHAR);
                                        } else {
                                            updateForType1_tDBSCD_1.setString(16, SEN_SCD.SENPRENOMUSE);
                                        }

                                        if (SEN_SCD.SENMAT == null) {
                                            updateForType1_tDBSCD_1.setNull(17, java.sql.Types.VARCHAR);
                                        } else {
                                            updateForType1_tDBSCD_1.setString(17, SEN_SCD.SENMAT);
                                        }
                            ...
                            lookUpValue_tDBSCD_1.CATPROCOD = SEN_SCD.CATPROCOD;
                            lookUpValue_tDBSCD_1.PCSCOD = SEN_SCD.PCSCOD;
                            lookUpValue_tDBSCD_1.QUACOD = SEN_SCD.QUACOD;
                            lookUpValue_tDBSCD_1.SENDATNAI = SEN_SCD.SENDATNAI;
                            lookUpValue_tDBSCD_1.SENDESPRO = SEN_SCD.SENDESPRO;
                            lookUpValue_tDBSCD_1.SENDPTNUMNAI = SEN_SCD.SENDPTNUMNAI;
                            lookUpValue_tDBSCD_1.SENEMA = SEN_SCD.SENEMA;
                            lookUpValue_tDBSCD_1.SENLIENAI = SEN_SCD.SENLIENAI;
                            lookUpValue_tDBSCD_1.SENNOMMAR = SEN_SCD.SENNOMMAR;
                            lookUpValue_tDBSCD_1.SENNOMPAT = SEN_SCD.SENNOMPAT;
                            lookUpValue_tDBSCD_1.SENNOMTEC = SEN_SCD.SENNOMTEC;
                            lookUpValue_tDBSCD_1.SENNOMUSE = SEN_SCD.SENNOMUSE;
                            lookUpValue_tDBSCD_1.SENNOMUSECAP = SEN_SCD.SENNOMUSECAP;
                            lookUpValue_tDBSCD_1.SENNUMTELSEN = SEN_SCD.SENNUMTELSEN;
                            lookUpValue_tDBSCD_1.SENPRENOMCIV = SEN_SCD.SENPRENOMCIV;
                            lookUpValue_tDBSCD_1.SENPRENOMUSE = SEN_SCD.SENPRENOMUSE;
                ...
                if (execStat) {
                    runStat.updateStat(resourceMap, iterateId, 2, 0, "SEN_SCD");
                }
    ...
    public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
        ...
        public java.util.Date dptdatdeb;

        public java.util.Date getDptdatdeb() {
            return this.dptdatdeb;
        }

        public java.util.Date dptdatfin;

        public java.util.Date getDptdatfin() {
    ...
    public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
        ...
        try {
            ...
            if (resumeIt || globalResumeTicket) { // start the resume
                ...
                // linked node: tMap_1 - inputs:(row1,row2,row3) outputs:(SEN_SCD)
                ...
                final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
                    "enc:routine.encryption.key.v1:gIu2+QOpIRol6fko/7FGUoUNdIFCeQKZSB5aGE4c0TBux/I7hnTztA=="
                );
                ...
                try {
                    ...
                    while (rs_tDBInput_2.next()) {
                        ...
                        if (colQtyInRs_tDBInput_2 < 2) {
                            ...
                            row2.dptcod = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
                        }
                        if (colQtyInRs_tDBInput_2 < 3) {
                            row2.dptlib = null;
                        } else {
                            row2.dptlib = routines.system.JDBCUtil.getString(rs_tDBInput_2, 3, false);
                        }
                        ...
                        if (colQtyInRs_tDBInput_2 < 5) {
                            ...
                            row2.dptmodscrsen = routines.system.JDBCUtil.getString(rs_tDBInput_2, 5, false);
                        }
                        if (colQtyInRs_tDBInput_2 < 6) {
                            row2.dptser = null;
                        } else {
                            row2.dptser = routines.system.JDBCUtil.getString(rs_tDBInput_2, 6, false);
                        }
                        if (colQtyInRs_tDBInput_2 < 7) {
                            row2.regcod = null;
                        } else {
                            row2.regcod = routines.system.JDBCUtil.getString(rs_tDBInput_2, 7, false);
                        }
                        ...
                        if (colQtyInRs_tDBInput_2 < 9) {
                            ...
                            row2.dptcodsirpas = routines.system.JDBCUtil.getString(rs_tDBInput_2, 9, false);
                        }
                        if (colQtyInRs_tDBInput_2 < 10) {
                            row2.dptlic = null;
                        } else {
                            row2.dptlic = routines.system.JDBCUtil.getString(rs_tDBInput_2, 10, false);
                        }
                        if (colQtyInRs_tDBInput_2 < 11) {
                            row2.dptart = null;
                        } else {
                            row2.dptart = routines.system.JDBCUtil.getString(rs_tDBInput_2, 11, false);
                        }
                        if (colQtyInRs_tDBInput_2 < 12) {
                            row2.dptlibtri = null;
                        } else {
                            row2.dptlibtri = routines.system.JDBCUtil.getString(rs_tDBInput_2, 12, false);
                        }
                        if (colQtyInRs_tDBInput_2 < 13) {
                            row2.temvalcod = null;
                        } else {
                            row2.temvalcod = routines.system.JDBCUtil.getString(rs_tDBInput_2, 13, false);
                        }
                        if (colQtyInRs_tDBInput_2 < 14) {
                            row2.evelic = null;
                        } else {
                            row2.evelic = routines.system.JDBCUtil.getString(rs_tDBInput_2, 14, false);
                        }
                        if (colQtyInRs_tDBInput_2 < 15) {
                            row2.evelib = null;
                        } else {
                            row2.evelib = routines.system.JDBCUtil.getString(rs_tDBInput_2, 15, false);
                        }
                        if (colQtyInRs_tDBInput_2 < 16) {
                            row2.evelil = null;
                        } else {
                            row2.evelil = routines.system.JDBCUtil.getString(rs_tDBInput_2, 16, false);
                        }
                        if (colQtyInRs_tDBInput_2 < 17) {
                            row2.eveobs = null;
                        } else {
                            row2.eveobs = routines.system.JDBCUtil.getString(rs_tDBInput_2, 17, false);
                        }
                        if (colQtyInRs_tDBInput_2 < 18) {
                            row2.dptser2004 = null;
                        } else {
                            row2.dptser2004 = routines.system.JDBCUtil.getString(rs_tDBInput_2, 18, false);
                        }
                        if (colQtyInRs_tDBInput_2 < 19) {
                            row2.dptcmt = null;
                        } else {
                            row2.dptcmt = routines.system.JDBCUtil.getString(rs_tDBInput_2, 19, false);
                        }
                        if (colQtyInRs_tDBInput_2 < 20) {
                            row2.dptcmtaff = null;
                        } else {
                            row2.dptcmtaff = routines.system.JDBCUtil.getString(rs_tDBInput_2, 20, false);
                        }
                        if (colQtyInRs_tDBInput_2 < 21) {
                            row2.dptdatdeb = null;
                        } else {
                            row2.dptdatdeb = routines.system.JDBCUtil.getDate(rs_tDBInput_2, 21);
                        }
                        if (colQtyInRs_tDBInput_2 < 22) {
                            row2.dptdatfin = null;
                        } else {
                            row2.dptdatfin = routines.system.JDBCUtil.getDate(rs_tDBInput_2, 22);
                        }
                        if (colQtyInRs_tDBInput_2 < 23) {
                            row2.evetempub = null;
                        } else {
                            row2.evetempub = routines.system.JDBCUtil.getString(rs_tDBInput_2, 23, false);
                        }
                        if (colQtyInRs_tDBInput_2 < 24) {
                            row2.dpturlcmp = null;
                        } else {
                            row2.dpturlcmp = routines.system.JDBCUtil.getString(rs_tDBInput_2, 24, false);
                        }
                        if (colQtyInRs_tDBInput_2 < 25) {
                            row2.dptminintcod = null;
                        } else {
                            row2.dptminintcod = routines.system.JDBCUtil.getString(rs_tDBInput_2, 25, false);
                        }
                        if (colQtyInRs_tDBInput_2 < 26) {
                            row2.syscredat = null;
                        } else {
                            row2.syscredat = routines.system.JDBCUtil.getDate(rs_tDBInput_2, 26);
                        }
                        if (colQtyInRs_tDBInput_2 < 27) {
                            row2.syscrelog = null;
                        } else {
                            row2.syscrelog = routines.system.JDBCUtil.getString(rs_tDBInput_2, 27, false);
                        }
                        if (colQtyInRs_tDBInput_2 < 28) {
                            row2.sysmajdat = null;
                        } else {
                            row2.sysmajdat = routines.system.JDBCUtil.getDate(rs_tDBInput_2, 28);
                        }
                        if (colQtyInRs_tDBInput_2 < 29) {
                            row2.sysmajlog = null;
                        } else {
                            row2.sysmajlog = routines.system.JDBCUtil.getString(rs_tDBInput_2, 29, false);
                        }
        ...
        try {
            ...
            if (resumeIt || globalResumeTicket) { // start the resume
                ...
                final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword(
                    "enc:routine.encryption.key.v1:HpFULFPvD/b1X58UvJqQeOPLZ/kBZ9qfRJRviJ2fnMwRrnKiWN3ZKg=="
                );
                ...
                try {
                    ...
                    while (rs_tDBInput_3.next()) {
                        ...
                        if (colQtyInRs_tDBInput_3 < 1) {
                            ...
                            row3.pcscod = routines.system.JDBCUtil.getString(rs_tDBInput_3, 1, false);
                        }
                        if (colQtyInRs_tDBInput_3 < 2) {
                            row3.pcslil = null;
                        } else {
                            row3.pcslil = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, false);
                        }
                        if (colQtyInRs_tDBInput_3 < 3) {
                            row3.pcs42cod = null;
                        } else {
                            row3.pcs42cod = routines.system.JDBCUtil.getString(rs_tDBInput_3, 3, false);
                        }
        ...
        try {
            ...
            if (resumeIt || globalResumeTicket) { // start the resume
                ...
                final String decryptedPassword_tDBRow_1 = routines.system.PasswordEncryptUtil.decryptPassword(
                    "enc:routine.encryption.key.v1:d6Th938bKJ/5qh39pOiPMv2k8fGzidGwytzUqA=="
                );
            ...
            if (resumeEntryMethodName == null || globalResumeTicket) {
                resumeUtil.addLog(
                    "CHECKPOINT",
                    "CONNECTION:SUBJOB_OK:tDBRow_1:OnSubjobOk",
                    "",
                    Thread.currentThread().getId() + "",
                    "",
                    "",
        ...
        try {
            ...
            if (resumeIt || globalResumeTicket) { // start the resume
                ...
                final String decryptedPassword_tDBRow_2 = routines.system.PasswordEncryptUtil.decryptPassword(
                    "enc:routine.encryption.key.v1:cPtRvJR+9WSkG5gujce5rydIh/fF9SjO778iBQ=="
                );
    ...
    public static void main(String[] args) {
        final Update_Etat_Civil_Sen Update_Etat_Civil_SenClass = new Update_Etat_Civil_Sen();

        int exitCode = Update_Etat_Civil_SenClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext =
                Update_Etat_Civil_Sen.class.getClassLoader()
                    .getResourceAsStream("irsen/update_etat_civil_sen_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext =
                    Update_Etat_Civil_Sen.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Update_Etat_Civil_Sen");
        }
...
/************************************************************************************************
 * 171780 characters generated by Talend Open Studio for Data Integration on the
 * 13 janvier 2022 à 15:03:15 CET
 ************************************************************************************************/
