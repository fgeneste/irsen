...
class AdressePostale2ResourceIT {
    ...
    void createAdressePostale2() throws Exception {
        ...
        assertThat(testAdressePostale2.getBister()).isEqualTo(DEFAULT_BISTER);
        assertThat(testAdressePostale2.getComplement1()).isEqualTo(DEFAULT_COMPLEMENT_1);
        assertThat(testAdressePostale2.getComplement2()).isEqualTo(DEFAULT_COMPLEMENT_2);
        assertThat(testAdressePostale2.getTypeVoie()).isEqualTo(DEFAULT_TYPE_VOIE);
        ...
        assertThat(testAdressePostale2.getAffichageInternet()).isEqualTo(DEFAULT_AFFICHAGE_INTERNET);
        assertThat(testAdressePostale2.getAffichageIntranet()).isEqualTo(DEFAULT_AFFICHAGE_INTRANET);
    }
    ...
    void putNewAdressePostale2() throws Exception {
        ...
        assertThat(testAdressePostale2.getBister()).isEqualTo(UPDATED_BISTER);
        assertThat(testAdressePostale2.getComplement1()).isEqualTo(UPDATED_COMPLEMENT_1);
        assertThat(testAdressePostale2.getComplement2()).isEqualTo(UPDATED_COMPLEMENT_2);
        assertThat(testAdressePostale2.getTypeVoie()).isEqualTo(UPDATED_TYPE_VOIE);
        ...
        assertThat(testAdressePostale2.getAffichageInternet()).isEqualTo(UPDATED_AFFICHAGE_INTERNET);
        assertThat(testAdressePostale2.getAffichageIntranet()).isEqualTo(UPDATED_AFFICHAGE_INTRANET);
    }
