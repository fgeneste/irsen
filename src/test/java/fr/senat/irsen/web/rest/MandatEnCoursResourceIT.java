...
class MandatEnCoursResourceIT {
    ...
    private static final String DEFAULT_DATE_ELECTION = "AAAAAAAAAA";
    private static final String UPDATED_DATE_ELECTION = "BBBBBBBBBB";
    ...
    void getAllMandatEnCours() throws Exception {
        ...
        restMandatEnCoursMockMvc
            ...
            .andExpect(jsonPath("$.[*].dateElection").value(hasItem(DEFAULT_DATE_ELECTION)))
    ...
    void getMandatEnCours() throws Exception {
        ...
        restMandatEnCoursMockMvc
            ...
            .andExpect(jsonPath("$.dateElection").value(DEFAULT_DATE_ELECTION))
